package edu.aku.hassannaqvi.template.core;
...
import edu.aku.hassannaqvi.template.contracts.FamilyMembersContract;
import edu.aku.hassannaqvi.template.contracts.FamilyMembersContract.familyMembers;
import edu.aku.hassannaqvi.template.contracts.FormsContract;
import edu.aku.hassannaqvi.template.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.template.contracts.TalukasContract;
import edu.aku.hassannaqvi.template.contracts.TalukasContract.singleTaluka;
import edu.aku.hassannaqvi.template.contracts.UCsContract;
import edu.aku.hassannaqvi.template.contracts.UCsContract.UCsTable;
import edu.aku.hassannaqvi.template.contracts.UsersContract;
import edu.aku.hassannaqvi.template.contracts.UsersContract.UsersTable;
import edu.aku.hassannaqvi.template.contracts.VillagesContract;
import edu.aku.hassannaqvi.template.contracts.VillagesContract.singleVillage;
